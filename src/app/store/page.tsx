        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Badge className="text-xs text-foreground bg-orange-500">PRE-ORDER</Badge>
            </div>
            <h1 className="text-3xl font-bold">GlowSoap v0.0.1</h1>
            <div className="flex items-center gap-2">
              <span className="text-3xl font-bold">$30.00</span>
              <span className="text-sm text-muted-foreground line-through">$37.50</span>
          ...
          <p className="text-muted-foreground">
            Pre-order the beta version of the GlowSoap for 20% off (applied after first feedback report)
          </p>
          ...
          <div className="space-y-4 rounded-lg border p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Free standard shipping on orders over $75</div>
              </div>
            </div>
            <div className="flex items-start gap-2">
